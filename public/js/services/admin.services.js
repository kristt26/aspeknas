angular.module('admin.service', [])
    ...
    .factory('klasifikasiServices', klasifikasiServices)
    .factory('subKlasifikasiServices', subKlasifikasiServices)
    .factory('pengajuanServices', pengajuanServices)
    .factory('pembayaranServices', pembayaranServices)
    .factory('validasiPengajuanServices', validasiPengajuanServices)
    .factory('userManajemenServices', userManajemenServices)
...
function klasifikasiServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'admin/klasifikasi/';
    var service = {};
    service.data = [];
    return {
        get: get,
...
function subKlasifikasiServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'admin/sub_klasifikasi/';
    var service = {};
    service.data = [];
    return {
        get: get,
...
function validasiPengajuanServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'admin/pengajuan/';
    var service = {};
    service.data = [];
    return {
        get: get,
    ...
    function put(param) {
        ...
        $http({
            ...
            (res) => {
                var data = service.data.pengajuan.find(x => x.id == param.id);
                if (data) {
...
function userManajemenServices ($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'admin/manajemen_user/';
    var service = {};
    service.data = [];
    return {
        get: get,
